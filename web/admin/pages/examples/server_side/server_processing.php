...
if (!empty($_POST) ) {
    ...
    define("HOST", "u426573602-ene.mysql.uhserver.com");
    define("USER", "u426573602_root");
    define("PASSWORD", "@p0sitiv02014");
    define("DB", "u426573602_ene");
    define("MyTable", "trabalhos_cientificos");

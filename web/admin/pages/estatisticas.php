        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Inscritos por Estado
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                                <div class="flot-chart-content" id="flot-por-estado"></div>
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Pagamentos
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                                <div class="flot-chart-content" id="flot-pagamentos"></div>
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Alojamento por estado
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div id="morris-alojamento"></div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Trabalhos por área do conhecimento
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                                <div class="flot-chart-content" id="flot-area-conhecimento"></div>
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Trabalhos por estado
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div id="morris-trabalhos-estado"></div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->

...
if($p == 'enviar')
{
	...
	if(empty($escolha) || empty($comentario) || empty($id) ){
		$msg['erro'] =  'Campos vazios. Tente novamente.';
		exit(json_encode($msg));
	}
	
	$rt = $con->prepare("SELECT titulo,cpf,autor2,aprovado,aprovado_banner,area,pet FROM trabalhos_cientificos where id=? limit 1");
	$rt->bindParam(1, $id);
	...
	if($rt->execute()){
		 //enviar e-mail de confirmação para o inscrito.
			...
			if($rt->rowCount() == 0 || $rt->rowCount() > 1 ){
				...
				if(($arq->aprovado == 1 || $arq->aprovado == 2 || $arq->aprovado == 4) && $arq->aprovado_banner == 0)
				{
					$msg['erro'] =  'Trabalho já avaliado. Tente avaliar outro trabalho.';
					exit(json_encode($msg));
				}elseif($arq->aprovado_banner == 1)
				{
				
					$msg['erro'] =  'Banner já aprovado. Tente avaliar outro trabalho.';
					exit(json_encode($msg));
				}
	...
	switch($escolha)
	{
		...
		case 2:
				...
				{
					//Erro de leitura
					$msg['erro'] = 'Não é possível pedir outro trabalho ao autor. Escolha outra opção.';
...
<body>
    ...
    <div id="wrapper">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i>Visitante <i class="fa fa-caret-down"></i>
                    </a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="divisaotrab.php"><i class="fa fa-tasks fa-fw"></i> Lista Divisão dos trabalhos</a>
						</li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Divisão de trabalhos</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge" id="confirmados">0</div>
                                    ...
                                    <form role="form" id="formAvaliacao">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="escolha">
                                                ...
                                                <option value="5">Trabalho aprovadíssimo. Banner aprovado.</option>
                                                <option value="6">Trabalho aprovado, porém Banner reprovado.</option>
                                            </select>
                                        </div>
										<div id="campo">
